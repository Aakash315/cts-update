$(document).ready(function () {
    ...
    $('#add-row-btn').click(function () {
        var newRow = `
            <tr>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="City Name">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="State">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="Country">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="Zip Code">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
        ...
        `;
        $('#cities-table-body').append(newRow);
    });
