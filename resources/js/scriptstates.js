$(document).ready(function () {
        ...
        var newRow = `
            <tr>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="State Name">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="State Code">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="Country">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="Type">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="Latitude">
                </td>
                <td class="px-6 py-4 text-sm font-medium text-gray-900">
                    <input type="text" class="w-full p-2 border rounded-md" placeholder="Longitude">
                </td>
                <td class="px-6 py-4 text-right">
                    <button type="button" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 save-btn">Save</button>
                    <button type="button" class="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-800 mt-2 delete-btn">Delete</button>
                </td>
            </tr>
        `;
        $('#states-table-body').append(newRow);
    });
    ...
    $('#search-input').on('input', function () {
        ...
        $('#states-table-body tr').each(function () {
