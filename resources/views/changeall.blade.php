...
<head>
    ...
    <title>Change Requests - All</title>
</head>
        ...
        <div class="min-h-screen bg-gray-50 p-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between items-center mb-8">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">All Change Requests</h1>
                        <p class="text-gray-500">Manage and track all change requests</p>
                    </div>
