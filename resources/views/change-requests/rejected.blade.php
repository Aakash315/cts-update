...
<head>
    ...
    <title>Rejected Change Requests</title>
</head>
        ...
        <div class="min-h-screen bg-gray-50 p-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex justify-between items-center mb-8">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Rejected Change Requests</h1>
                        <p class="text-gray-500">Manage and track rejected change requests</p>
                    </div>
                ...
                @if($rejectedRequests->isEmpty())
                    <div class="mt-4 text-gray-500">No rejected change requests found.</div>
                @endif
            </div>
        </div>
    </div>
